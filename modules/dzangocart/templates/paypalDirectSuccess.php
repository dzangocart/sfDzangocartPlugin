<div class="paypal-direct">
  <h2>
    <?php echo __('%provider% transactions', array('%provider%' => 'PayPal Direct Payment'), 'dzangocart'); ?>
  </h2>
  <div id="sf_admin_content" class="transactions">
    <?php echo $filterForm->render(); ?>
    <?php echo form_tag($module . '/batchAction', array('id' => 'paypal-direct-form')); ?>
      <table class="list paypal">
        <thead>
          <tr>
            ...
            <th class="payment"><?php echo __('Payment means', null, 'dzangocart'); ?></th>
      ...
      <input type="hidden" name="type" value="paypalDirect" />
